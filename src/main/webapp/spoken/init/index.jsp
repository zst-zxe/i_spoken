...
<header>
    <!--<div class="header_btm">
        <img src="img/talking.jpg" alt="背景图片" width="100%" height="70px"/>
    </div>-->
        ...
        <div class="header_btm">
            <div class="wrap">
                <div class="header_sub">
                    <div class="h_menu">
                        <!--<ul>
                            <li><a href="./login.html" target="_blank">首页</a></li>
                            <li>|</li>
                            <li><a href="./register.html" target="_blank" >社区</a></li>
                            <li>|</li>
                            <li><a href="">收藏</a></li>
                            <li>|</li>
                            <li><a href="./self_info.html">课程</a></li>
                            <li>|</li>
                            <li><a href="">购物车</a></li>
                        </ul>-->
                        <div style="display:block;background:transparent;position:absolute;top:15px;right: 10px;background-color: rgba(197,227,255,0.15)">
                            <div>
                                <a href="#">
                                    <img src="../../img/4.PNG" alt="用户头像"/>
                                </a>
                            </div>
                            <br>
                            <div style="text-align:center;">
                                <span><a class="tologin" href="${pageContext.request.contextPath}/spoken/init/login.jsp" style="font-size:14px;font-family: 黑体;text-decoration:none;" onclick="login();">用户登录</a></span>
                            </div>
                        </div>
...
<div class="banner_x center">
    ...
    <a href="index.html" target="_blank"><div class=""></div></a>
    ...
    <div class="nav fl" style="float: right;top:auto;margin-top:12px ;margin-bottom: 8px">
        <ul>
            ...
            <li>|</li>
            <li><a href="${pageContext.request.contextPath}/spoken/init/jump.jsp">社区</a></li>
            <li>|</li>
            <li><a href="jump.html">收藏</a></li>
            <li>|</li>
            <li><a href="jump.html">课程</a></li>
            <li>|</li>
            <li><a href="jump.html">购物车</a></li>
        </ul>
        <div class="search fr" >
                ...
                <div class="pop">
                    <div class="left fl">
                        <div>
                            ...
                            <div class="xuangou_right fr"><a href="jump.html">进入</a></div>
                            <div class="clear"></div>
                        </div>
                        <div>
                            <div class="xuangou_left fl">
            ...
            <li>
                ...
                <div class="pop">
                    ...
                    <div class="ctn fl">
                        ...
                        <div>
                            <div class="xuangou_left fl"><a href="jump.html"><div class="img fl"><img src=../../img/youxi.jpg></div>
                                <span class="fl">游戏</span>
                                <div class="clear"></div>
                            </a></div>
                            <div class="xuangou_right fr"><a href="jump.html">进入</a></div>
            ...
            <li>
                ...
                <div class="pop">
                    ...
                    <div class="ctn fl">
                        ...
                        <div>
                            <div class="xuangou_left fl"><a href="jump.html">
                ...
                <div class="pop">
                    ...
                    <div class="ctn fl">
                        ...
                        <div>
                            ...
                            <div class="xuangou_right fr"><a href="jump.html">进入</a>
                            </div>
                            <div class="clear"></div>
                        </div>
